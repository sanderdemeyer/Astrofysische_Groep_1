...
colors = sns.color_palette('husl', n_colors=rows-2)
...
for row in [r for r in range(rows) if r in [0, 11, 12, 1, 2, 4, 10]]:
...
plt.title('Perturbed criss-cross - fixed timestep - low orders', fontsize=15)
plt.show()
